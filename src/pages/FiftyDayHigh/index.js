...
const gainBandColor = (pct) => {
  if (pct >= 60) return COLORS.CHARTBOOK.BAND_STRONG;
  if (pct >= 40) return COLORS.CHARTBOOK.BAND_MID;
  if (pct >= 20) return COLORS.CHARTBOOK.BAND_WEAK;
                            ...
                            <Box display="flex" justifyContent="center" alignItems="center">
                              <Chip
                                ...
                                sx={{
                                  ...
                                  color:
                                    selectedStock?.code === row.code ? COLORS.CHARTBOOK.SELECTED_INK : gainBandColor(row.min_50d_gain_percent),
                                  border: `1px solid ${
                                    selectedStock?.code === row.code ? COLORS.CHARTBOOK.SELECTED_INK : gainBandColor(row.min_50d_gain_percent)
                                  }`,
                                  borderRadius: "2px",
