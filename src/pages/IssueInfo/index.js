...
function IssueInfo() {
  ...
  const MiniChart = ({ data, color, width = 120, height = 60 }) => {
    ...
    return (
      <Box sx={{ 
        ...
        <MKTypography variant="caption" color="text" sx={{ 
          display: 'block', 
          textAlign: 'center', 
          mt: 0.5,
          opacity: 0.7,
  ...
  const mockIssueData = {
    economicNews: [
      ...
      },
      {
        ...
        content: "코스피 지수가 연일 상승세를 보이며 4년 만의 최고점 경신 가능성이 높아지고 있습니다.",
        category: "시장동향",
        importance: "high",
        date: "2025-07-30",
        time: "10:30"
  ...
  const getChangeIcon = (change) => {
    const iconColor = change > 0 ? theme.palette.error.main : 
                     change < 0 ? theme.palette.info.main : 
  ...
  const getImpactColor = (impact) => {
    switch (impact) {
      case '긍정적': return 'success';
      case '부정적': return 'error';
      case '중립': return 'default';
    ...
    <>
      ...
      >
        <Grid container spacing={3} sx={{ px: { xs: 2, sm: 3, md: 4 } }}>
          ...
          {/* 주요 지수 */}
          <Grid item xs={12}>
            <Card sx={{ mb: 3, boxShadow: "0 2px 12px rgba(0,0,0,0.08)", border: "1px solid rgba(0,0,0,0.06)" }}>
              <CardContent sx={{ p: 3 }}>
                      ...
                      >
                        <CardContent sx={{ p: 2.5 }}>
                              ...
                              <MKBox display="flex" alignItems="center" justifyContent="flex-end">
                                ...
                                <MKTypography 
                                  ...
                                  sx={{ 
                                    ml: 0.5, 
                                    fontWeight: "medium",
                                    color: index.change > 0 ? theme.palette.error.main : 
                                           index.change < 0 ? theme.palette.info.main : 
                                           theme.palette.text.primary
                                  }}
                                >
                          ...
                          <MKBox>
                            ...
                            <MKTypography variant="caption" color="text" sx={{ mt: 1.5, display: 'block', opacity: 0.8 }}>
                              {index.description}
                            </MKTypography>
                          </MKBox>
                        </CardContent>
          ...
          <Grid item xs={12}>
            ...
            >
              ...
              <MKTypography variant="body2" color="text" sx={{ opacity: 0.8 }}>
                주요 지수 데이터는 FinanceDataReader를 통해 실시간으로 제공되며, 15분마다 자동 업데이트됩니다.
                투자 결정시 참고용으로만 활용하시기 바랍니다.
