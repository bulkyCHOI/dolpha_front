              ...
              <CardContent>
                ...
                <Stack spacing={1}>
                  <Box display="flex" justifyContent="space-between">
                    ...
                    <Typography variant="body2">{getTradingModeLabel(row.trading_mode)}</Typography>
                  </Box>
                  ...
                  <Box display="flex" justifyContent="space-between">
                    ...
                    <Typography variant="body2">{Math.round(row.holding_days)}일</Typography>
                  </Box>
                </Stack>
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell component="th" scope="row">
                      <Box>
                        <Typography variant="subtitle2">{row.stock_name}</Typography>
                    ...
                    <TableCell align="right">{Math.round(row.holding_days)}일</TableCell>
            ...
            <Stack spacing={2} sx={{ mt: 1 }}>
              <Box display="flex" justifyContent="space-between">
                ...
                <Typography variant="body2">
                  {detailDialog.stock_name} ({detailDialog.stock_code})
                </Typography>
              </Box>
              <Box display="flex" justifyContent="space-between">
                <Typography variant="body2" color="text.secondary">
              ...
              <Box display="flex" justifyContent="space-between">
                ...
                <Typography variant="body2">
                  {formatNumber(detailDialog.total_buy_amount)}원
                </Typography>
              </Box>
              <Box display="flex" justifyContent="space-between">
                <Typography variant="body2" color="text.secondary">
                ...
                <Typography variant="body2">
                  {formatNumber(detailDialog.total_sell_amount)}원
                </Typography>
              </Box>
              <Box display="flex" justifyContent="space-between">
                <Typography variant="body2" color="text.secondary">
                ...
                <Typography variant="body2">
                  {detailDialog.entry_count} / {detailDialog.exit_count}
                </Typography>
              </Box>
              <Box display="flex" justifyContent="space-between">
                <Typography variant="body2" color="text.secondary">
